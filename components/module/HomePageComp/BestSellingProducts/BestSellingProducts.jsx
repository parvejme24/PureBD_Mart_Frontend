...
import { ArrowRight, TrendingUp, Star, ShoppingCart, Plus, Minus, Heart } from "lucide-react";
      ...
      <div className="container mx-auto max-w-7xl px-4 py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {Array.from({ length: 4 }).map((_, index) => (
            <div key={index} className="bg-[#D8F1E5]/5 rounded-lg p-4 border border-[#3BB77E]/10">
    ...
    <div className="container mx-auto max-w-7xl px-4 py-14">
      <div className="mb-5 flex justify-between items-center w-full">
        <div className="flex items-center gap-2">
          <TrendingUp className="h-6 w-6 text-[#3BB77E]" />
          <div>
        ...
        {products.map((product) => (
          <div key={product._id} className="relative group">
            ...
            <Link href={`/shop/${encodeURIComponent(product.slug || product._id)}`}>
              <div className="bg-[#D8F1E5]/5 rounded-lg p-4 border border-[#3BB77E]/10 hover:border-[#3BB77E]/30 transition-all duration-300 hover:shadow-md cursor-pointer">
                <div className="flex gap-4">
                  {/* Product Image */}
                  <div className="shrink-0">
                    <div className="relative w-20 h-20 rounded-lg overflow-hidden bg-white shadow-sm">
                      <Image
                        src={product.image?.url || product.image || "/placeholder-product.png"}
                        alt={product.name}
                        fill
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col items-end gap-2 ml-4">
                        <p className="font-bold text-[#3BB77E] text-base">৳{product.price}</p>
                        ...
                        {!product.stock > 0 ? (
                          ...
                          <div className="flex items-center gap-1">
                            <Button
                              ...
                              className="bg-[#DEF9EC] hover:bg-[#3BB77E] text-[#50BB88] hover:text-white text-xs px-3 py-1 h-7 font-semibold transition-colors cursor-pointer"
                            >
